 ...
 */
@Controller
@RequestMapping("/salesquotationinquiry")

public class SalesQuotationInquiryController {
    ...
    public String index(Model model) {
        Pageable pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by("qtno").descending());
        ...
        return "module/sales/inquiriesandreports/salesquotationinquiry";
    }
}
