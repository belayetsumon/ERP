...
import com.itgarden.ERP.module.sales.model.transactions.CustomerCreditNotes;
...
public class CustomerCreditNotesController {
    ...
    public String index(Model model, CustomerCreditNotes customerCreditNotes) {
        ...
        transactionsType = transactionsTypeRepository.findBySlug("customer-credit-note");
        customerCreditNotes.setTransactionsType(transactionsType);

        SalesCartItem salesCartItem = new SalesCartItem();

        model.addAttribute("salesCartItem", salesCartItem);
        return "module/sales/transactions/customercreditnotes";
    }
