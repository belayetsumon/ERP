...
//
    ...
    public CustomerPayments(Long cuPaymentId, TransactionsType transactionsType, Customers customers, String paymentReference, Date paymentDate, BankAccounts bankAccounts, BigDecimal bankCharge, BigDecimal alloc, BigDecimal discount, BigDecimal amount, String memo, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
    ...
    public Long getCuPaymentId() {
        return cuPaymentId;
    }

    public void setCuPaymentId(Long cuPaymentId) {
        this.cuPaymentId = cuPaymentId;
    }
