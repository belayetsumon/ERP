...
//
    ...
    public SalesInvoiceItem(Long id, SalesInvoice salesInvoice, TransactionsType transactionsType, Items itemId, String description, BigDecimal unitPrice, BigDecimal quantity, BigDecimal discount_percent, BigDecimal discountTotal, BigDecimal unitTax, BigDecimal totalTax, BigDecimal itemTotal, BigDecimal standard_cost, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
