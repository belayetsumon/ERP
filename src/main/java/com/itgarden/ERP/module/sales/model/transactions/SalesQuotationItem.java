...
public class SalesQuotationItem {
    ...
    SalesQuotationEntry salesQuotationEntry;
...
//
    ...
    public SalesQuotationItem(Long id, SalesQuotationEntry salesQuotationEntry, TransactionsType transactionsType, Items itemId, String description, BigDecimal unitPrice, BigDecimal quantity, BigDecimal discount_percent, BigDecimal discountTotal, BigDecimal unitTax, BigDecimal totalTax, BigDecimal itemTotal, BigDecimal standard_cost, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
        this.salesQuotationEntry = salesQuotationEntry;
    ...
    public SalesQuotationEntry getSalesQuotationEntry() {
        return salesQuotationEntry;
    }

    public void setSalesQuotationEntry(SalesQuotationEntry salesQuotationEntry) {
        this.salesQuotationEntry = salesQuotationEntry;
    }
