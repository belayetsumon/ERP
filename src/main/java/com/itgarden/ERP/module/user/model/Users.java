...
public class Users implements Serializable {
    ...
    public Users(Long id, String name, String email, String mobile, String password, Set<Role> role, Status status, String remarks, Date lastLogin, Date lastLogOut, String createdBy, Date updatedOn, String updatedBy) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.mobile = mobile;
